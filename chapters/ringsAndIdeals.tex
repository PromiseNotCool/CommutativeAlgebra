        ...
        \item 
            ...
            \begin{center}
                \begin{tikzpicture}[node distance = 1.5cm, auto]
                    ...
                    \node (aX)[node distance=0.8cm, left of=R, above of=R] {$\sum_{i=0}^\infty b_iX^i$};
                    \node (a)[node distance=0.8cm, right of=S, above of=S] {$b_0$};
                    \node (aaX)[node distance=0.8cm, left of=Ra, below of=AaX] {$\sum_{i=0}^\infty \overbar b_i X^i$};
                    \node (aa)[node distance=0.8cm, right of=Ra, below of=Aa] {$\overbar b_0$};
