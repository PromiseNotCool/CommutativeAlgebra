...
\begin{proof}
    \begin{enumerate}
        ...
        \item[(a)] Note that $\ffp = \ffa_1 \cdots \ffa_n \supseteq \ffa_i$ for $i = 1,\dots,n$. Also, we have $\ffp = \ffa_1 \cdots \ffa_n \subseteq \ffa_1 \cap \cdots \cap \ffa_n$ by Fact~\ref{1.38}\ref{1.38f}. So $\ffp \subseteq \ffa_i$ for $i = 1,\dots,n$. \qedhere
    \end{enumerate}
\end{proof}
