...
\begin{definition}
    Let $\ffa \leq R$ and $S \subseteq R$. Let 
    \begin{enumerate}[(a)]
        \item 
...
\begin{example}
    ...
    \begin{enumerate}[(a)]
        \item $(\langle XY \rangle: \{X,Y\}) = (\langle XY \rangle: \{X,Y\}) = (\langle XY \rangle: X) \cap (\langle XY \rangle : Y) = \langle Y \rangle \cap \langle X \rangle = \langle XY \rangle$.
...
\begin{fact}
    ...
    \begin{enumerate}[(a)]
        ...
        \item If $\ffa \subseteq \ffb$, then $\operatorname{rad}(\ffa) \subseteq \operatorname{rad}(\ffb)$ (converse fails).
        \item $\ffa \subseteq \operatorname{rad}(\ffa) = \operatorname{rad}(\operatorname{rad}(\ffa))$ (equality fails in general). 
...
\begin{example}
    ...
    $\frac{\bbF_2[X,Y]}{\langle X^2,XY,Y^2 \rangle} \geq \langle \overline X, \overline Y \rangle \cong \bbF_2^2$. Let $\ffb_1 = \langle \overline X, \overline Y \rangle$, $\ffb_2 = \langle \overline X + \overline Y \rangle$ and $\ffb_3 = \langle Y \rangle$. Then $\langle \overline X,\overline Y \rangle = \ffb_1 \cup \ffb_2 \cup \ffb_2$, but $\ffb_i \subseteq \langle \overline X,\overline Y \rangle$ for any $i = 1,2,3$.
\end{example}
...
\begin{example}
    \begin{enumerate}
        \item [(b)] If $\operatorname{rad}(\ffa)+\operatorname{rad}(\ffb)$, then we may not have $\ffa \subseteq \ffb$. 
        \item [(c)]
        \item [(d)]
    \end{enumerate}
\end{example}

\begin{definition}[extension and contraction of ideals along ring homomorphisms]
    Let $\varphi: R \to S$ be a ring homomorphism. Let $\ffa \leq R$, then the \emph{extension} of $\ffa$ along $\varphi$ is $\ffa^e = \ffa S = \langle \varphi(\ffa) \rangle \leq S$. Let $\ffb \leq S$, then the \emph{extraction} of $\ffb$ along $\varphi$ is $\ffa^c = \varphi^{-1}(\ffb) \leq R$.
\end{definition}

\begin{example}
    \begin{enumerate}
        \item[(a)] Let $R$ be an integral domain with field of fraction $Q(R)$. Then $R \subseteq Q(R)$ with the inclusion map $\epsilon:R \to Q(R)$ given by $\varepsilon(r) = r/1$. If $0 \neq \ffa \leq R$, then $\ffa Q(R) = Q(R)$ and $0Q(R) = 0$.
        \item[(b)] Note $\langle X\rangle k[X] \subseteq k[X] \subseteq k[X,Y]$, $\left(\langle X \rangle k[X]\right)k[X,Y] = \langle X \rangle k[X,Y]$.
        \item[(c)] Let $R \subseteq S$ be rings and $\varepsilon: R \xrightarrow \subseteq S$. Let $\ffb \subseteq S$, then $\varepsilon^{-1}(\ffb) = \ffb \cap R$.
        \item[(b)]
    \end{enumerate}
\end{example}
...
\begin{proposition}
    ...
    \begin{enumerate}[(a)]
        \item $\ffa \subseteq f^{-1}(\ffa S)$. If $\ffa_1 \subseteq \ffb_1$, then $\ffa_1S \subseteq \ffa_2S$. $f^{-1}(\ffb)S \subseteq \ffb$. If $\ffb_1 \subseteq \ffb_2$, then $f^{-1}(\ffb_1) \subseteq f^{-1}(\ffb_2)$. If $T \subseteq R$, then $(\langle T \rangle R)S = \langle f(T) \rangle S$.
        \item $\ffa S = f^{-1}(\ffa S)S$, $f^{-1}(\ffb) = f^{-1}(f^{-1}(\ffb)S)$.
        \item $(\ffa_1 + \ffa_2)S = \ffa_1S + \ffa_2S$. $f^{-1}(\ffb_1) + f^{-1}(\ffb_2) \subseteq f^{-1}(\ffb_1 + \ffb_2)$, not equal in general.
        \item $(\ffa_1 \cap \ffa_2)S \subseteq \ffa_1S \cap \ffa_2S$, $f^{-1}(\ffb_1 \cap \ffb_2) = f^{-1}(\ffb_1) \cap f^{-1}(\ffb_2)$.
        \item $(\ffa_1\ffa_2)S = (\ffa_1S)(\ffa_2S)$, $f^{-1}(\ffb_1)f^{-1}(\ffb_2) \subseteq f^{-1}(\ffb_1\ffb_2)$.
        \item $(\ffa_1:\ffa_2)S \subseteq (\ffa_1S:\ffa_2S)$, $f^{-1}(\ffb_1:\ffb_2) \subseteq (f^{-1}(\ffb_1):f^{-1}(\ffb_2))$.
...
\begin{proof}
    \begin{enumerate}[(a)]
        \item LHS gen. over $S$ by $f(\langle T \rangle R)$, $f(\sum_i^{\text{finite}}t_ir_i) = \sum_i^{\text{finite}} f(t_i)f(r_i) \in \langle f(T) \rangle S$. gen of RHS is $f(t) = f(t \cdot 1)$ gen. of LHS.
        \item 
            \begin{itemize}
                \item 
