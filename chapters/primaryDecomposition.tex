...
\begin{definition}[Calculus content]
    Let $R = \bbC[X_1,\cdots,X_d]$ and $\ffp \in \operatorname{Spec}(R)$ (Zariski). $\ffp^{(2)} = \{f \mid f \in \ffp, \frac{\partial f}{ \partial x_i} \in \ffp,\fa i = 1,\cdots,d\}$, $\ffp^{(n)} = \{f \in \ffp \mid \frac{\partial^{i} f}{\partial \underline x} \in \ffp, \text{ all partials of order } i = 1,\cdots,n-1\}$.
\end{definition}
