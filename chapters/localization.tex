...
\begin{notation}\label{3.4}
    \begin{enumerate}
        \item If $U = \{1,f,f^2,\cdots\}$, write $U^{-1}R = R_f$. ($R_f = 0$ for $f \in \operatorname{Nil}(R)$.
...
\begin{proof}
    \begin{enumerate}
        ...
        \item ``$\subseteq$''. By Proposition \ref{3.11}\ref{3.11e} and \ref{1.63}\ref{1.63f}, $U^{-1}(\ffb:\ffa) = (\ffb:\ffa) \cdot U^{-1}R \subseteq (\ffb \cdot U^{-1}R: \ffa \cdot U^{-1}R) = (U^{-1}\ffb:U^{-1}\ffa)$. \par 
            ``$\supseteq$''. Let $\frac{r}{u} \in U^{-1}R$ with $r \in R,u \in U$ such that $\frac{r}{u} \in (U^{-1}\ffb:U^{-1}\ffa)$. Since $\ffa$ is finitely generated, $\ffa = \langle a_{1},\ldots,a_{n} \rangle R$ for some $n \geq 1$ and $a_{1},\ldots,a_{n} \in R$. Then $U^{-1}\ffa = \langle \frac{a_{1}}{1},\ldots,\frac{a_{n}}{1} \rangle U^{-1}R$. Since $\frac{r}{u} \in (U^{-1}\ffb:U^{-1}\ffa)$, $\frac{ra_{i}}{u} = \frac{r}{u} \frac{a_{i}}{1} \in U^{-1}\ffb$ for $i = 1,\ldots,n$. So by Proposition \ref{3.11}\ref{3.11b}, there exists $v_{i} \in U$ such that $v_{i} ra_{i} \in \ffb$ for $i = 1,\ldots,n$. Let $v = v_{1} \cdots v_{n} \in U$. Then $(vr)a_{i} \in \ffb$ for $i = 1,\ldots,n$. So $vr \in (\ffb:\ffa)$. Thus, $\frac{r}{u} \in U^{-1}(\ffb:\ffa)$ by Proposition \ref{3.11}\ref{3.11b}. \qedhere
    \end{enumerate}
\end{proof}
...
\begin{example*}
    \begin{enumerate}
        ...
        \item 
            Let $a_1,\ldots,a_d \in k$. Then, similarly, 
            \[\frac{k[X_1,\ldots,X_d]_{(X_1-a_1,\ldots,X_d-a_d)}}{(X_1-a_1,\ldots,X_d-a_d)_{(X_1-a_1,\ldots,X_d-a_d)}} \cong Q\biggl(\frac{k[X_1,\ldots,X_d]}{(X_1-a_1,\ldots,X_d-a_d)}\biggr) \cong Q(k) = k.\] 
    \end{enumerate}
\end{example*}
...
\begin{example}\label{3.27}
    \begin{enumerate}
        \item Let $\varphi: R \xhookrightarrow \subseteq R[X_1,\ldots,R_d]$.
            \begin{enumerate}
                \item If $(R,\ffm)$ is local, then $\llF(\ffm) \cong \frac{R[X_1,\ldots,X_d]}{\ffm \cdot R[X_1,\ldots,X_d]} = \frac{R[X_1,\ldots,X_d]}{\ffm [X_1,\ldots,X_d]} \cong \frac{R}{\ffm}[X_1,\ldots,X_d]$.
                \item If $\ffp \in \operatorname{Spec}(R)$, then with $U = R \smallsetminus \ffp$, we have 
                    \[\llF(\ffp) = \frac{U^{-1}(R[X_1,\ldots,X_d])}{\ffp \cdot U^{-1}(R[X_1,\ldots,X_d])} \cong \frac{(U^{-1}R)[X_1,\ldots,X_n]}{(\ffp U^{-1}R)[X_1,\ldots,X_n]} \cong \frac{R_\ffp}{\ffp_\ffp}[X_1,\ldots,X_n] \cong Q\Bigl(\frac{R}{\ffp}\Bigr)[X_1,\ldots,X_d]\]
                        since $U^{-1}(R[X]) \cong (U^{-1}R)[X]$ defined by $\frac{\sum_{i=1}^{\text{finite}}r_ix^{i}}{u} \mapsto \sum_{i=1}^{\text{finite}}\frac{r_i}{u}x^{i}$.
            \end{enumerate}
        \item 
            Let $R \xhookrightarrow{\subseteq} R\llbracket X_1,\ldots,X_d \rrbracket$.
            \begin{enumerate}
                \item If $(R,\ffm)$ is local, then $\llF(\ffm) \cong \frac{R}{\ffm}\llbracket X_1,\ldots,X_d \rrbracket$ similarly.
            \end{enumerate}
        \item
            Let $k$ be a field and $\varphi: k[X_1,\ldots,X_d] \xhookrightarrow{\subseteq} k\llbracket X_1,\ldots,X_d \rrbracket$.
            \begin{enumerate}
                \item Let $\ffm = \langle X_1,\ldots,X_d \rangle = k[X_1,\ldots,X_d]$ be maximal. Then $\ffm \cdot k\llbracket X_1,\ldots,X_d \rrbracket = \langle X_1,\ldots,X_d \rangle \leq k\llbracket X_1,\ldots,X_d \rrbracket$. So with $U = k[X_1,\ldots,X_d] \smallsetminus \ffm$, $\llF(\ffm) = \frac{U^{-1}(k\llbracket X_1,\ldots,X_d \rrbracket)}{\ffm \cdot U^{-1}(k\llbracket X_1,\ldots,X_d \rrbracket)} \cong \frac{k\llbracket X_1,\ldots,X_d \rrbracket}{\ffm \cdot k\llbracket X_1,\ldots,X_d \rrbracket} \cong \frac{k\llbracket X_1,\ldots,X_d \rrbracket}{\langle X_1,\ldots,X_d \rangle} \cong k$ since $U^{-1}(R\llbracket X \rrbracket) \cong (U^{-1}R)\llbracket X \rrbracket $ given by $\frac{\sum_{i=1}^{\infty}r_ix^{i}}{u} \mapsto \sum_{i=1}^{\infty}\frac{r_i}{u}x^{i}$.
